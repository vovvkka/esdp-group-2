            ...
            <div className="container">
                <div className="success-order__block">
                    <div className="success-order__title-block">
                        ...
                        <div className='success-order__location'>Главная — Оформление заказа —<span
                            className='success-order__location-page'> Заказ получен</span></div>
                    </div>
                    ...
                    <div className="success-order__received">
                        <div className="success-order__received-info">
                            ...
                            <div className="success-order__message">
                                <p className="success-order__message-title">Заказ успешно оформлен</p>
                                <p className="success-order__message-sub-title">Мы свяжемся с вами в ближайшее
                                    время!</p>
                            </div>
                        </div>

                        <div className="success-order__received-button">
                            <button className="success-order__button" onClick={() => dispatch(historyPush('/'))}>
                                Перейти на главную
                            </button>
                        </div>
                    </div>
